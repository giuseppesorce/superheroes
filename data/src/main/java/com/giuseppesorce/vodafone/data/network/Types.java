 ...
 */
package com.giuseppesorce.vodafone.data.network;
...
import static com.giuseppesorce.vodafone.data.network.Util.EMPTY_TYPE_ARRAY;
...
public final class Types {
  ...
  public static boolean equals(@Nullable Type a, @Nullable Type b) {
    if (a == b) {
      ...
      Type[] aTypeArguments =
          pa instanceof Util.ParameterizedTypeImpl ? ((Util.ParameterizedTypeImpl) pa).typeArguments
              : pa.getActualTypeArguments();
      Type[] bTypeArguments =
          pb instanceof Util.ParameterizedTypeImpl ? ((Util.ParameterizedTypeImpl) pb).typeArguments
